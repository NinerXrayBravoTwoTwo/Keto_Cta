...
public class SerializationJsonTest(ITestOutputHelper testOutputHelper)
{
    ...
    {
        var json = "{\"Id\":\"123\",\"VisitDate\":\"2023-10-01T00:00:00Z\",\"Tps\":10,\"Cac\":20,\"Ncpv\":30.5,\"Tcpv\":40.5,\"Pav\":50.5}";
    ...
    {
        var json = "{\"Id\":\"123\",\"VisitDate\":\"2023-10-01T00:00:00Z\",\"Tps\":10,\"Cac\":20,\"Ncpv\":30.5,\"Tcpv\":40.5,\"Pav\":50.5,\"LnTps\":2.302585092994046,\"LnCac\":2.995732173547877,\"LnNcpv\":3.4011973816621555,\"LnTcpv\":3.6888794541139363,\"LnPav\":3.912023005428146}";
        var visit = System.Text.Json.JsonSerializer.Deserialize<Visit>(json);
        Assert.NotNull(visit);
        Assert.Equal("123", visit.Id);
        Assert.Equal(10, visit.Tps);
    ...
    {
        var json = "{\"Id\":\"Element1\",\"Visits\":[{\"Id\":\"V1\",\"VisitDate\":null,\"Tps\":0,\"Cac\":0,\"Ncpv\":0.0,\"Tcpv\":0.0,\"Pav\":0.0},{\"Id\":\"V2\",\"VisitDate\":null,\"Tps\":0,\"Cac\":0,\"Ncpv\":0.0,\"Tcpv\":0.0,\"Pav\":0.0}],\"MemberSet\":1}";
